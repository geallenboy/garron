...
const styleLint = require('./stylelintLint');
const typescriptLint = require('./typescriptLint');
const vue3Lint = require('./vue3Lint');

module.exports = { javascriptLint, prettierLint, reactLint, styleLint, typescriptLint, vue3Lint };
